...
--Q5. Do subscribed customer spends more? Compare average spend and total revenue between subscribers and non-subscribers.
...
--Q6. Which 5 product has the highest percentage of purchases with discounts applied?
...
select "age-group", SUM(purchase_amount)
from customer
group by "age-group"
